...
namespace DP_GMM {
    ...
    DPMixtureComponent::DPMixtureComponent(const Data &data, int data_point_index,
    ...
    DPMixtureComponent::~DPMixtureComponent() { }

    void DPMixtureComponent::addDataPoint(int index, const EiVector &xi, double rho,
    ...
    bool DPMixtureComponent::removeDataPoint(int index, const EiVector &xi,
    ...
    void DPMixtureComponent::computeUpdateVectorForWStar(double rho,
    ...
    void DPMixtureComponent::updateMixtureParameters(const EiVector &xi, double rho,
                                                     const EiMatrix &W, double beta) {
        updateWStar(xi, rho, W, beta);
    ...
    void DPMixtureComponent::updateWStar(const EiVector &xi, double rho,
                                         const EiMatrix &W, double beta) {
    ...
    void DPMixtureComponent::sampleMeanFromPosteriorWithPrecision(
    ...
    void DPMixtureComponent::recomputeEmpiricalMeanAndMatrix() {
    ...
    void DPMixtureComponent::invertRankOneUpdate(const EiVector &u, double scal,
                                                 EiMatrix *inv_A) {
    ...
    GaussMixtureComponent DPMixtureComponent::getGaussComponent() {
