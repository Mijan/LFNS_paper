...
namespace DP_GMM {
    ...
    class DPMixtureComponent {
    public:
        DPMixtureComponent(const EiMatrix &data, int data_point_index,
    ...
    typedef std::shared_ptr<DPMixtureComponent> DPMixtureComponentPtr;
    typedef std::unordered_set<DPMixtureComponentPtr> MixtureComponentSet;
} /* namespace DP_GMM2 */
